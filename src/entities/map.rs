// use amethyst::{
//     assets::{AssetStorage, Format, Handle, Loader, ProgressCounter},
...
//         sprite::{SpriteSheetFormat, SpriteSheetHandle, TextureCoordinates},
//         Sprite,
//         SpriteRender,
//         SpriteSheet,
//         Texture,
...
// // pub fn add_environment_layer(world: &mut World, map: Map, sprite_sheet_handle: SpriteSheetHandle) {
// //     let env_layer = map.layers.iter()
// //         .find(|layer| layer.name == "environment").unwrap();

// //     for obj in env_layer.objects.iter() {
// //         // match obj.objtype.as_ref() {
// //         //     "background" => {},
// //         //     "platform" => {},
// //         //     "truss" => {}
// //         //     _ => {}
// //         // }
// //         let tileset = map.tilesets.iter().find(|tileset| tileset.name == obj.objtype).unwrap();
...
// //         //     format!("prefabs/{}.ron", tileset.name),
// //         //     SpriteSheetFormat(texture_handle),
// //         //     progress_counter,
// //         //     &sprite_sheet_store,
// //         // );

// //         let sprite_index_prop = obj.properties.iter().find(|prop| prop.name == "spriteindex");
...
// pub fn load_map_layer(world: &mut World, map: &Map, tileset_id: u32, layer_index: usize, texture_handle: Handle<Texture>) {
...
//                 left: y as f32 * tileset_sprite_offset_columns * -1.,
//                 right: (y + 1) as f32 * tileset_sprite_offset_columns * -1.,
